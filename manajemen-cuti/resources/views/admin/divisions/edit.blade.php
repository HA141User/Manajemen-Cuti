        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-paper shadow-[0_8px_30px_rgb(0,0,0,0.04)] sm:rounded-3xl border border-cream overflow-hidden">
                ...
                <div class="bg-primary/5 px-8 py-6 border-b border-cream flex items-center gap-4">
                    ...
                    <div>
                        <h3 class="text-lg font-bold text-primary">Edit Departemen</h3>
                        <p class="text-sm text-secondary/70">Divisi: {{ $division->name }}</p>
                    </div>
                </div>
                ...
                <div class="p-8">
                    <form action="{{ route('divisions.update', $division->id) }}" method="POST">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" name="name" value="{{ old('name', $division->name) }}" class="w-full rounded-xl border-secondary/20 bg-cream/10 focus:border-accent focus:ring-accent text-primary placeholder-secondary/40 transition shadow-sm" required>
                        </div>
