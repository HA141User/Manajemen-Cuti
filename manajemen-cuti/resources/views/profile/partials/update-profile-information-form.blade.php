    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6" enctype="multipart/form-data">
        ...
        <div>
            ...
            <div class="flex items-center space-x-4 mt-2">
                <div class="shrink-0">
                    @if($user->avatar)
                        <img class="h-16 w-16 object-cover rounded-full border" src="{{ asset('storage/' . $user->avatar) }}" alt="Current profile photo" />
                    @else
        ...
        <div>
            ...
            <x-text-input id="username" name="username" type="text" class="mt-1 block w-full bg-gray-50" :value="old('username', $user->username)" required />
        ...
        <div>
            ...
            <p class="text-xs text-gray-500 mt-1">*Hubungi Admin jika ingin mengubah role.</p>
        </div>
